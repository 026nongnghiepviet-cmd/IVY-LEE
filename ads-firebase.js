...
function initAdsAnalysis() {
    ...
    console.log("Ads Module V157 Mobile App UI Loaded");
    ...
    window.toggleAdsMobileFilters = toggleAdsMobileFilters;
    window.updateAdsMobileFilterSummary = updateAdsMobileFilterSummary;
...
function injectCustomStyles() {
    ...
    style.innerHTML = `
        ...
        /* =========================================================
           V157 MOBILE APP UI — ONLY <= 767PX
           Desktop and tablet layouts remain unchanged.
           ========================================================= */
        .ads-mobile-appbar-copy,
        .ads-mobile-filter-trigger,
        .ads-mobile-filter-backdrop,
        .ads-mobile-filter-sheet-head,
        .ads-mobile-filter-done,
        .ads-mobile-activity-mount {
            display:none;
        }

        .ads-mobile-appbar-actions {
            display:flex;
            align-items:center;
            gap:8px;
        }
        ...
        @media (max-width:767px) {
            :root {
                --ads-mobile-blue:#1f6fff;
                --ads-mobile-blue-soft:#eaf2ff;
                --ads-mobile-bg:#f4f7fb;
                --ads-mobile-text:#14283b;
                --ads-mobile-muted:#718196;
                --ads-mobile-surface:#ffffff;
                --ads-mobile-border:#e4eaf1;
                --ads-mobile-nav-height:72px;
            }

            body.ads-mobile-filter-sheet-open {
                overflow:hidden !important;
            ...
            #ads-analysis-result {
                min-height:100dvh;
                border-radius:0 !important;
                background:var(--ads-mobile-bg) !important;
                box-shadow:none !important;
                overflow:visible !important;
            ...
            #ads-analysis-result .ads-enterprise-main {
                display:block !important;
                padding:0 12px calc(var(--ads-mobile-nav-height) + 28px + env(safe-area-inset-bottom)) !important;
                background:var(--ads-mobile-bg) !important;
            }
            ...
            #ads-analysis-result .ads-enterprise-topbar {
                ...
                padding:calc(9px + env(safe-area-inset-top)) 14px 10px !important;
                display:flex !important;
                ...
                box-shadow:0 5px 18px rgba(18,43,69,.06);
            }
            ...
            #ads-analysis-result .ads-mobile-appbar-copy {
                min-width:0;
                display:flex !important;
                align-items:center;
                gap:10px;
            ...
            #ads-analysis-result .ads-mobile-app-logo {
                width:42px;
                height:42px;
                flex:0 0 42px;
                display:flex;
                ...
                font-size:17px;
                font-weight:700;
                background:linear-gradient(145deg,#1f6fff,#5a98ff);
                box-shadow:0 8px 20px rgba(31,111,255,.25);
            }

            #ads-analysis-result .ads-mobile-app-title {
                min-width:0;
                display:flex;
                flex-direction:column;
                line-height:1.15;
            ...
            #ads-analysis-result .ads-mobile-app-title > span {
                color:#7c8da0;
                font-size:8px;
                font-weight:700;
                letter-spacing:.9px;
            ...
            #ads-analysis-result .ads-mobile-app-title > strong {
                margin-top:2px;
                color:var(--ads-mobile-text);
                font-size:17px;
                font-weight:700;
                white-space:nowrap;
                overflow:hidden;
            ...
            #ads-analysis-result .ads-mobile-app-title > small {
                margin-top:3px;
                color:var(--ads-mobile-muted);
                font-size:9.5px;
                font-weight:600;
                white-space:nowrap;
                overflow:hidden;
            ...
            #ads-analysis-result .ads-mobile-appbar-actions {
                display:flex;
                align-items:center;
                gap:7px;
                flex:0 0 auto;
            ...
            #ads-analysis-result .ads-topbar-status b {
                display:none !important;
            }
            ...
            #ads-analysis-result .ads-mobile-filter-trigger {
                width:42px;
                height:42px;
                ...
                background:#fff;
                color:#34516d;
                box-shadow:0 5px 14px rgba(19,44,71,.08);
                cursor:pointer;
            }

            #ads-analysis-result .ads-mobile-filter-trigger[aria-expanded="true"] {
                color:#fff;
                border-color:var(--ads-mobile-blue);
                background:var(--ads-mobile-blue);
            }

            #ads-analysis-result .ads-mobile-filter-glyph {
                width:19px;
                display:grid;
                gap:4px;
            }

            #ads-analysis-result .ads-mobile-filter-glyph i {
                position:relative;
                display:block;
                width:19px;
                height:2px;
            ...
            #ads-analysis-result .ads-mobile-filter-glyph i:nth-child(1)::after,
            #ads-analysis-result .ads-mobile-filter-glyph i:nth-child(3)::after {
                content:"";
                position:absolute;
                top:50%;
                width:5px;
            ...
            #ads-analysis-result .ads-mobile-filter-glyph i:nth-child(1)::after { left:3px; }
            #ads-analysis-result .ads-mobile-filter-glyph i:nth-child(3)::after { right:3px; }

            /* Activity cards */
            #ads-analysis-result .ads-mobile-activity-mount {
                display:block !important;
                margin-bottom:12px;
            }

            #ads-analysis-result .ads-mobile-activity-mount:empty {
                display:none !important;
            }

            #ads-analysis-result .ads-mobile-activity-mount .ads-sidebar-activity {
                display:block !important;
                margin:0 !important;
                padding:12px !important;
                border:1px solid var(--ads-mobile-border) !important;
                border-radius:18px !important;
                background:var(--ads-mobile-surface) !important;
                box-shadow:0 8px 22px rgba(19,44,71,.06);
            }

            #ads-analysis-result .ads-mobile-activity-mount .ads-sidebar-activity-head {
                margin:0 0 9px !important;
            }

            #ads-analysis-result .ads-mobile-activity-mount .ads-sidebar-activity-list {
                display:flex !important;
                gap:8px !important;
            ...
            #ads-analysis-result .ads-mobile-activity-mount .ads-sidebar-activity-list::-webkit-scrollbar {
                display:none;
            }

            #ads-analysis-result .ads-mobile-activity-mount .ads-sidebar-activity-item,
            #ads-analysis-result .ads-mobile-activity-mount .ads-sidebar-activity-empty {
            ...
            /* Material-like bottom navigation */
            #ads-analysis-result .ads-enterprise-sidebar {
                ...
                width:100% !important;
                height:calc(var(--ads-mobile-nav-height) + env(safe-area-inset-bottom)) !important;
                min-height:0 !important;
                padding:7px 8px calc(7px + env(safe-area-inset-bottom)) !important;
                display:block !important;
                border:0 !important;
                border-top:1px solid rgba(213,222,232,.95) !important;
                border-radius:0 !important;
                background:rgba(255,255,255,.96) !important;
                backdrop-filter:blur(18px) saturate(1.25);
                -webkit-backdrop-filter:blur(18px) saturate(1.25);
                box-shadow:0 -10px 28px rgba(20,47,74,.10) !important;
                overflow:visible !important;
            }
            ...
            #ads-analysis-result .ads-sidebar-section-label,
            #ads-analysis-result .ads-sidebar-help,
            #ads-analysis-result .ads-enterprise-sidebar > .ads-sidebar-activity {
                display:none !important;
            }
            ...
            #ads-analysis-result .ads-mobile-filter-backdrop {
                position:fixed;
                inset:0;
                z-index:118;
                width:100%;
            ...
            #ads-analysis-result .ads-command-bar {
                ...
                left:0 !important;
                right:0 !important;
                bottom:calc(var(--ads-mobile-nav-height) + env(safe-area-inset-bottom)) !important;
                ...
                box-shadow:0 -18px 55px rgba(13,36,58,.22) !important;
                transform:translateY(115%);
                pointer-events:none;
                transition:transform .26s cubic-bezier(.2,.8,.2,1);
            }

            #ads-analysis-result.ads-mobile-filter-open .ads-mobile-filter-backdrop {
                opacity:1;
                pointer-events:auto;
            }

            #ads-analysis-result.ads-mobile-filter-open .ads-command-bar {
                transform:translateY(0);
                pointer-events:auto;
            }

            #ads-analysis-result .ads-command-bar::before {
                content:"";
                width:42px;
                height:4px;
                margin:0 auto 2px;
            ...
            #ads-analysis-result .ads-mobile-filter-sheet-head {
                display:flex !important;
                align-items:center;
                justify-content:space-between;
                gap:12px;
            ...
            #ads-analysis-result .ads-mobile-filter-sheet-head > div {
                min-width:0;
                display:flex;
                flex-direction:column;
            }

            #ads-analysis-result .ads-mobile-filter-sheet-head span {
                color:#7c8da0;
                font-size:8px;
                font-weight:700;
                letter-spacing:.8px;
            ...
            #ads-analysis-result .ads-mobile-filter-sheet-head strong {
                margin-top:2px;
                color:var(--ads-mobile-text);
                font-size:16px;
                font-weight:700;
            ...
            #ads-analysis-result .ads-mobile-filter-sheet-head button {
                width:38px;
                height:38px;
                border:0;
                border-radius:12px;
            ...
            #ads-analysis-result .report-clear-btn,
            #ads-analysis-result .ads-mobile-filter-done {
                width:100% !important;
                height:46px !important;
                margin:0 !important;
                border-radius:13px !important;
            ...
            #ads-analysis-result .ads-mobile-filter-done {
                ...
                align-items:center;
                justify-content:center;
                border:1px solid var(--ads-mobile-blue);
                background:var(--ads-mobile-blue);
                color:#fff;
                cursor:pointer;
            }
            ...
            #ads-analysis-result #kpi-performance.active,
            #ads-analysis-result #kpi-finance.active {
                display:flex !important;
            ...
            #ads-analysis-result #kpi-performance.active::-webkit-scrollbar,
            #ads-analysis-result #kpi-finance.active::-webkit-scrollbar {
                display:none;
            }
            ...
            #ads-analysis-result .ads-metric-card {
                ...
                border-color:var(--ads-mobile-border) !important;
                box-shadow:0 8px 22px rgba(19,44,71,.07) !important;
            }
            ...
            /* Content surfaces */
            #ads-analysis-result .ads-tab-content.active {
                gap:12px !important;
            }
            ...
            #ads-analysis-result .ads-content-card {
                ...
                border-radius:19px !important;
                border-color:var(--ads-mobile-border) !important;
                box-shadow:0 8px 22px rgba(19,44,71,.055) !important;
            }

            #ads-analysis-result .ads-content-card-head,
            #ads-analysis-result .ads-content-head-actions {
                flex-direction:column !important;
                align-items:stretch !important;
            }
            ...
            #ads-analysis-result .meta-live-status-chip #meta-live-status-text {
                overflow:hidden;
                white-space:nowrap;
                text-overflow:ellipsis;
            }
            ...
            /* Key tables become app-like data cards */
            #tab-performance .table-responsive,
            #tab-finance .table-responsive {
                overflow:visible !important;
                border:0 !important;
                background:transparent !important;
            }

            #tab-performance .ads-table,
            #tab-finance .ads-table {
                display:block !important;
                min-width:0 !important;
                width:100% !important;
                background:transparent !important;
            ...
            #tab-performance .ads-table > thead,
            #tab-finance .ads-table > thead {
                display:none !important;
            }
            ...
            #ads-table-fin > tr {
                ...
                background:#fff;
                box-shadow:0 7px 18px rgba(19,44,71,.055);
            }

            #ads-table-perf > tr[data-meta-live-configured-only="1"] {
                background:#f5f6f8 !important;
            }

            #ads-table-perf > tr > td,
            #ads-table-fin > tr > td {
                min-width:0;
                padding:0 !important;
                display:flex !important;
            ...
            #ads-table-perf > tr > td::before,
            #ads-table-fin > tr > td::before {
                color:#8795a4;
                font-size:8px;
                font-weight:700;
                letter-spacing:.55px;
            ...
            #ads-table-perf > tr > td:nth-child(1),
            #ads-table-perf > tr > td:nth-child(2),
            #ads-table-perf > tr > td:nth-child(3),
            #ads-table-fin > tr > td:nth-child(1),
            #ads-table-fin > tr > td:nth-child(2) {
                grid-column:1 / -1;
            }

            #ads-table-perf > tr > td:nth-child(1)::before { content:"Chiến dịch"; }
            #ads-table-perf > tr > td:nth-child(2)::before { content:"Nhóm quảng cáo"; }
            #ads-table-perf > tr > td:nth-child(3)::before { content:"Trạng thái"; }
            #ads-table-perf > tr > td:nth-child(4)::before { content:"Ngân sách"; }
            #ads-table-perf > tr > td:nth-child(5)::before { content:"Chi phí"; }
            #ads-table-perf > tr > td:nth-child(6)::before { content:"Tin / Mua"; }
            #ads-table-perf > tr > td:nth-child(7)::before { content:"Mua / Tin"; }
            #ads-table-perf > tr > td:nth-child(8)::before { content:"CTR liên kết"; }
            #ads-table-perf > tr > td:nth-child(9)::before { content:"Giá tin / Đơn"; }
            #ads-table-perf > tr > td:nth-child(10)::before { content:"Bắt đầu"; }

            #ads-table-fin > tr > td:nth-child(1)::before { content:"Chiến dịch"; }
            #ads-table-fin > tr > td:nth-child(2)::before { content:"Sản phẩm"; }
            #ads-table-fin > tr > td:nth-child(3)::before { content:"Chi phí gốc"; }
            #ads-table-fin > tr > td:nth-child(4)::before { content:"VAT"; }
            #ads-table-fin > tr > td:nth-child(5)::before { content:"Phí chênh lệch"; }
            #ads-table-fin > tr > td:nth-child(6)::before { content:"Tổng chi"; }
            #ads-table-fin > tr > td:nth-child(7)::before { content:"Doanh thu"; }
            #ads-table-fin > tr > td:nth-child(8)::before { content:"ROAS"; }

            #ads-table-perf > tr > td[colspan],
            #ads-table-fin > tr > td[colspan] {
                grid-column:1 / -1;
                align-items:center !important;
                text-align:center !important;
            ...
            #ads-table-perf > tr > td[colspan]::before,
            #ads-table-fin > tr > td[colspan]::before {
                display:none;
            }
            ...
            /* Secondary wide tables stay within their own scroll area */
            #tab-trend .table-responsive,
            ...
            /* Mobile drill-down as full-width bottom sheet */
            #meta-live-original-rows-modal {
                align-items:flex-end !important;
                padding:0 !important;
            }

            #meta-live-original-rows-modal > div {
                width:100vw !important;
                max-width:100vw !important;
                height:min(94dvh,940px) !important;
        ...
        container.innerHTML = `
            ...
            <div class="ads-enterprise-shell">
                ...
                <main class="ads-enterprise-main">
                    <button type="button" class="ads-mobile-filter-backdrop" aria-label="Đóng bộ lọc" onclick="window.toggleAdsMobileFilters(false)"></button>

                    <header class="ads-enterprise-topbar">
                        <div class="ads-mobile-appbar-copy">
                            <div class="ads-mobile-app-logo">A</div>
                            <div class="ads-mobile-app-title">
                                <span>ADS CONTROL</span>
                                <strong id="ads-mobile-screen-title">Meta Live</strong>
                                <small id="ads-mobile-filter-summary">Đang tải bộ lọc...</small>
                            </div>
                        </div>
                        ...
                        <div class="ads-mobile-appbar-actions">
                            <div class="ads-topbar-status">
                                <span></span>
                                <b>Hệ thống hoạt động</b>
                            </div>
                            <button type="button" class="ads-mobile-filter-trigger" aria-expanded="false" aria-controls="ads-mobile-filter-sheet" onclick="window.toggleAdsMobileFilters()">
                                <span class="ads-mobile-filter-glyph" aria-hidden="true"><i></i><i></i><i></i></span>
                                <span class="sr-only">Mở bộ lọc</span>
                            </button>
                        </div>
                    </header>

                    <div class="ads-mobile-activity-mount" id="ads-mobile-activity-mount"></div>

                    <section class="ads-command-bar" id="ads-mobile-filter-sheet">
                        <div class="ads-mobile-filter-sheet-head">
                            <div>
                                <span>BỘ LỌC DỮ LIỆU</span>
                                <strong>Chọn phạm vi hiển thị</strong>
                            </div>
                            <button type="button" onclick="window.toggleAdsMobileFilters(false)" aria-label="Đóng bộ lọc">×</button>
                        </div>
                        ...
                        <button type="button" class="ads-mobile-filter-done" onclick="window.toggleAdsMobileFilters(false)">Xong</button>
                    </section>
...
const ADS_MOBILE_APP_BREAKPOINT = 767;
let ADS_MOBILE_APP_BOUND = false;
let ADS_MOBILE_APP_MEDIA = null;

function isAdsMobileViewport() {
    return window.matchMedia
        ? window.matchMedia(`(max-width:${ADS_MOBILE_APP_BREAKPOINT}px)`).matches
        : window.innerWidth <= ADS_MOBILE_APP_BREAKPOINT;
}

function formatAdsMobileShortDate(value) {
    const match = String(value || '').match(/^(\d{4})-(\d{2})-(\d{2})$/);
    return match ? `${match[3]}/${match[2]}` : '';
}

function updateAdsMobileFilterSummary() {
    const summary = document.getElementById('ads-mobile-filter-summary');
    if (!summary) return;

    const company = COMPANIES.find(item => item.id === CURRENT_COMPANY);
    const companyLabel = company ? company.name : CURRENT_COMPANY;

    const fromInput = document.getElementById('date-from');
    const toInput = document.getElementById('date-to');
    const monthInput = document.getElementById('report-month-filter');

    const from = String((fromInput && fromInput.value) || DATE_FROM || '');
    const to = String((toInput && toInput.value) || DATE_TO || '');
    const month = String((monthInput && monthInput.value) || REPORT_MONTH || '');

    let periodLabel = '';
    if (from || to) {
        periodLabel = `${formatAdsMobileShortDate(from) || '—'}–${formatAdsMobileShortDate(to) || '—'}`;
    } else if (month) {
        const parts = month.split('-');
        periodLabel = parts.length === 2 ? `${parts[1]}/${parts[0]}` : month;
    } else {
        periodLabel = 'Tháng hiện tại';
    }

    summary.textContent = `${companyLabel} · ${periodLabel}`;
}

function updateAdsMobileAppHeader(tabName = CURRENT_TAB) {
    const title = document.getElementById('ads-mobile-screen-title');
    if (!title) return;

    const labels = {
        performance: 'Meta Live',
        finance: 'Tài chính',
        trend: 'Ma trận',
        report: 'Báo cáo MKT'
    };

    title.textContent = labels[tabName] || 'Quảng cáo';
    updateAdsMobileFilterSummary();
}

function toggleAdsMobileFilters(forceOpen) {
    const root = document.getElementById('ads-analysis-result');
    const trigger = document.querySelector('#ads-analysis-result .ads-mobile-filter-trigger');
    if (!root) return;

    if (!isAdsMobileViewport()) {
        root.classList.remove('ads-mobile-filter-open');
        document.body.classList.remove('ads-mobile-filter-sheet-open');
    ...
    const shouldOpen = typeof forceOpen === 'boolean'
        ? forceOpen
        : !root.classList.contains('ads-mobile-filter-open');

    root.classList.toggle('ads-mobile-filter-open', shouldOpen);
    document.body.classList.toggle('ads-mobile-filter-sheet-open', shouldOpen);
...
function syncAdsMobileAppLayout() {
    const root = document.getElementById('ads-analysis-result');
    const sidebar = document.querySelector('#ads-analysis-result .ads-enterprise-sidebar');
    const activity = document.getElementById('ads-sidebar-activity');
    const activityMount = document.getElementById('ads-mobile-activity-mount');
    const sidebarHelp = document.querySelector('#ads-analysis-result .ads-sidebar-help');

    if (!root || !sidebar) return;

    const mobile = isAdsMobileViewport();
    root.classList.toggle('ads-mobile-app-mode', mobile);

    if (mobile) {
        if (activity && activityMount && activity.parentNode !== activityMount) {
            activityMount.appendChild(activity);
        }
    } else {
        if (activity && activity.parentNode !== sidebar) {
            sidebar.insertBefore(activity, sidebarHelp || null);
        }
        toggleAdsMobileFilters(false);
    }

    updateAdsMobileAppHeader(CURRENT_TAB);
}

function setupAdsMobileAppShell() {
    syncAdsMobileAppLayout();

    if (ADS_MOBILE_APP_BOUND) return;
    ADS_MOBILE_APP_BOUND = true;

    ADS_MOBILE_APP_MEDIA = window.matchMedia
        ? window.matchMedia(`(max-width:${ADS_MOBILE_APP_BREAKPOINT}px)`)
        : null;

    const handleViewportChange = () => syncAdsMobileAppLayout();

    if (ADS_MOBILE_APP_MEDIA) {
        if (typeof ADS_MOBILE_APP_MEDIA.addEventListener === 'function') {
            ADS_MOBILE_APP_MEDIA.addEventListener('change', handleViewportChange);
        } else if (typeof ADS_MOBILE_APP_MEDIA.addListener === 'function') {
            ADS_MOBILE_APP_MEDIA.addListener(handleViewportChange);
        }
    } else {
    ...
    document.addEventListener('change', event => {
        if (event.target && event.target.closest && event.target.closest('#ads-mobile-filter-sheet')) {
            window.setTimeout(updateAdsMobileFilterSummary, 0);
        }
    });

    document.addEventListener('click', event => {
        if (event.target && event.target.closest && event.target.closest('.report-clear-btn')) {
            window.setTimeout(updateAdsMobileFilterSummary, 0);
        }
    });
...
function switchAdsTab(tabName) { 
    ...
    CURRENT_TAB = tabName;
    updateAdsMobileAppHeader(tabName);
    toggleAdsMobileFilters(false); 
